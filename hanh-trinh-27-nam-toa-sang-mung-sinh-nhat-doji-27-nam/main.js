$(function() {
    ...
    $(window).on('load', function() {
      ...
      var day = '2021/07/12 08:30:00';
      var datetimeStart = '2021/07/15 08:30:00';
      var datetimeEnd = '2021/07/31 19:30:00';
      if (Date.now() < Date.parse(datetimeStart)) {
        day = '2021/07/15 08:30:00';
    ...
    $('#dat-coc').find('.view-more').on('click','a', function() {
      $('#popup-dat-coc').addClass('avai');
    });
  
    $('#popup-dat-coc').find('.close').on('click', function() {
      $('#popup-dat-coc').removeClass('avai');
    });
    ...
    $(window).bind('load',function(){
      ...
      // $('#lp-kcv-bst-sp').not('.slick-initialized').slick({
      //   infinite: false,
      //   autoplay: true,
      //   speed: 400,
      //   slidesToScroll: 1,
